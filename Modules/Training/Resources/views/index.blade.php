             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              ...
              <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Title</label>
                    <div class="col-sm-10">
                    <input type="text"  name="title" id="title" placeholder="Enter Title Name" value="{{old('title')}}" required="required" class="form-control">
                ...
                <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Icon</label>
                    <div class="col-sm-10">
                    <input type="text"  name="icon" id="icon" placeholder="Enter Icon Name" value="{{old('icon')}}" required="required" class="form-control">
