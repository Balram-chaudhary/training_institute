             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              ...
              <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Name</label>
                    <div class="col-sm-10">
                    <input type="text"  name="name" id="name" placeholder="Enter Course Name" value="{{old('name')}}" required="required" class="form-control">
                ...
                <div class="form-group">
                    <label for="slider" class="col-sm-2 control-label">Course Image</label>
                    <div class="col-sm-10">
