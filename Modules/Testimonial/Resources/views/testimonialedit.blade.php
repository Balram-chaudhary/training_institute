             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              ...
              <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Name</label>
                    <div class="col-sm-10">
                    <input type="text"  name="name" id="name" placeholder="Enter  Name" value="{{$testimonial->name}}" required="required" class="form-control">
                ...
                <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Organization Name</label>
                    <div class="col-sm-10">
                    <input type="text"  name="oname" id="oname" placeholder="Enter Organization Name" value="{{$testimonial->oname}}" required="required" class="form-control">
                 ...
                 <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Post</label>
                    <div class="col-sm-10">
                    <input type="text"  name="post" id="post" placeholder="Enter Post Name" value="{{$testimonial->post}}" required="required" class="form-control">
               ...
               <div class="col-lg-1 col-md-1 col-sm-1">
                 <a href="{{url('/public/images/'.$testimonial->image)}}"class="portfolio-box">
                  <img src="{{url('/public/images/'.$testimonial->image)}}"class="img-responsive" alt="images" width="400px" height="400px">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Message</label>
                    <div class="col-sm-10">
                    <textarea  name="message" id="message" placeholder="Enter Message"  required="required" class="form-control">{!!$testimonial->message!!}</textarea>
