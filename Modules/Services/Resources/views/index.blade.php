             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              ...
              <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Service Title</label>
                    <div class="col-sm-10">
                    <input type="text"  name="title" id="title" placeholder="Enter Service Title " value="{{old('title')}}" required="required" class="form-control">
                     <span class="help-block errortext">{{$errors->first('title')}}</span>
                 </div>
                </div>
                <div class="form-group">
                   <label for="name" class="col-sm-2 control-label">Service Icon</label>
                    <div class="col-sm-10">
                    <input type="text"  name="icon" id="icon" placeholder="Enter Service Icon" value="{{old('icon')}}" required="required" class="form-control">
